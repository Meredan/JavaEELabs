...
public class LoginCheck extends UsernamePasswordAuthenticationFilter {
    private final ObjectMapper objectMapper;

    LoginCheck(final AuthenticationManager authenticationManager, final ObjectMapper objectMapper) {
